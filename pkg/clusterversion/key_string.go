...
func _() {
	__antithesis_instrumentation__.Notify(37222)
...
var _Key_index = [...]uint16{0, 5, 14, 36, 54, 76, 113, 152, 175, 189, 230, 256, 275, 309, 321, 352, 376, 397, 425, 455, 483, 504, 517, 536, 570, 608, 642, 674, 710, 742, 778, 820, 839, 879, 911, 930, 954, 975, 1006, 1024, 1065, 1095, 1106, 1137, 1160, 1193, 1217, 1241, 1263, 1276, 1288, 1314, 1328, 1349, 1367}

func (i Key) String() string {
	__antithesis_instrumentation__.Notify(37223)
	if i < 0 || func() bool {
		__antithesis_instrumentation__.Notify(37225)
		return i >= Key(len(_Key_index)-1) == true
	}() == true {
		__antithesis_instrumentation__.Notify(37226)
		return "Key(" + strconv.FormatInt(int64(i), 10) + ")"
	} else {
		__antithesis_instrumentation__.Notify(37227)
	}
	__antithesis_instrumentation__.Notify(37224)
