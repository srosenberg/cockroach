...
func ExampleGCEMachineType() {
	arch := []vm.CPUArch{vm.ArchAMD64, vm.ArchARM64}
	mem := []spec.MemPerCPU{spec.Auto, spec.Standard, spec.High, spec.Low}
	...
	for _, a := range arch {
		...
		for _, m := range mem {
			fmt.Printf("\tmem: %s\n", m)
			for _, i := range cpu {
				machineType, selectedArch := spec.SelectGCEMachineType(i, m, a)
				fmt.Printf("\t\t%s %s\n", machineType, selectedArch)
			}
		}
	}
	// Output:
	...
	//		n2-standard-4 amd64
	//		n2-standard-8 amd64
	//		n2-standard-16 amd64
	//		n2-custom-32-65536 amd64
	//		n2-custom-64-131072 amd64
	//		n2d-custom-96-196608 amd64
	//		n2d-custom-128-262144 amd64
	//	mem: standard
	//		n2-standard-2 amd64
	//		n2-standard-2 amd64
	//		n2-standard-4 amd64
	//		n2-standard-8 amd64
	//		n2-standard-16 amd64
	//		n2-standard-32 amd64
	//		n2-standard-64 amd64
	//		n2-standard-96 amd64
	//		n2-standard-128 amd64
	//	mem: high
	//		n2-highmem-2 amd64
	//		n2-highmem-2 amd64
	//		n2-highmem-4 amd64
	...
	//		t2a-standard-8 arm64
	//		t2a-standard-16 arm64
	//		n2-custom-32-65536 amd64
	//		n2-custom-64-131072 amd64
	//		n2d-custom-96-196608 amd64
	//		n2d-custom-128-262144 amd64
...
func ExampleAWSMachineType() {
	arch := []vm.CPUArch{vm.ArchAMD64, vm.ArchARM64}
	mem := []spec.MemPerCPU{spec.Auto, spec.Standard, spec.High}
	cpu := []int{1, 2, 4, 8, 16, 32, 64, 96, 128}
	...
	for _, a := range arch {
		...
		for _, m := range mem {
			fmt.Printf("\tmem: %s\n", m)
			for _, i := range cpu {
				machineType, selectedArch, err := spec.SelectAWSMachineType(i, m, false, a)
				if err != nil {
					panic(err)
				}
				fmt.Printf("\t\t%s %s\n", machineType, selectedArch)
...
func ExampleAzureMachineType() {
	...
	for _, a := range arch {
		...
		for _, m := range mem {
			fmt.Printf("\tmem: %s\n", m)
			for _, i := range cpu {
				machineType, selectedArch, err := spec.SelectAzureMachineType(i, m, a)
				if err != nil {
					panic(err)
				}
				fmt.Printf("\t\t%s %s\n", machineType, selectedArch)
	...
	// arch: amd64
	//	mem: auto
	//		Standard_D2ds_v5 amd64
	//		Standard_D2ds_v5 amd64
	//		Standard_D4ds_v5 amd64
	//		Standard_D8ds_v5 amd64
	//		Standard_D16ds_v5 amd64
	//		Standard_D32lds_v5 amd64
	//		Standard_D64lds_v5 amd64
	//		Standard_D96lds_v5 amd64
	//		Standard_D128lds_v5 amd64
	//	mem: standard
	//		Standard_D2ds_v5 amd64
	//		Standard_D2ds_v5 amd64
	//		Standard_D4ds_v5 amd64
	//		Standard_D8ds_v5 amd64
	//		Standard_D16ds_v5 amd64
	//		Standard_D32ds_v5 amd64
	//		Standard_D64ds_v5 amd64
	//		Standard_D96ds_v5 amd64
	//		Standard_D128ds_v5 amd64
	//	mem: high
	//		Standard_E2ds_v5 amd64
	//		Standard_E2ds_v5 amd64
	//		Standard_E4ds_v5 amd64
	//		Standard_E8ds_v5 amd64
	//		Standard_E16ds_v5 amd64
	//		Standard_E32ds_v5 amd64
	//		Standard_E64ds_v5 amd64
	//		Standard_E96ds_v5 amd64
	//		Standard_E128ds_v5 amd64
	//arch: arm64
	//	mem: auto
	//		Standard_D2pds_v5 arm64
	//		Standard_D2pds_v5 arm64
	//		Standard_D4pds_v5 arm64
	//		Standard_D8pds_v5 arm64
	//		Standard_D16pds_v5 arm64
	//		Standard_D32plds_v5 arm64
	//		Standard_D64plds_v5 arm64
	//		Standard_D96lds_v5 amd64
	//		Standard_D128lds_v5 amd64
	//	mem: standard
	//		Standard_D2pds_v5 arm64
	...
	//		Standard_D8pds_v5 arm64
	//		Standard_D16pds_v5 arm64
	//		Standard_D32pds_v5 arm64
	//		Standard_D64pds_v5 arm64
	//		Standard_D96ds_v5 amd64
	//		Standard_D128ds_v5 amd64
	//	mem: high
	//		Standard_E2pds_v5 arm64
	//		Standard_E2pds_v5 arm64
	//		Standard_E4pds_v5 arm64
	//		Standard_E8pds_v5 arm64
	//		Standard_E16pds_v5 arm64
	//		Standard_E32pds_v5 arm64
	//		Standard_E64ds_v5 amd64
	//		Standard_E96ds_v5 amd64
	//		Standard_E128ds_v5 amd64
}
